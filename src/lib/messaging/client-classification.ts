 ...
 * 
 * Implements explicit classification rules per Messaging Master Spec V1:
 * - For threads without recurring weekly plan, mark as one-time by default unless owner marks recurring
 * - If booking is linked, derive from booking recurrence flags
 */
