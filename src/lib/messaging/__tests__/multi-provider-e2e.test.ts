...
describe('Webhook handler basics', () => {
  it('OpenPhone provider parseInbound handles missing fields gracefully', () => {
    const { OpenPhoneProvider } = require('@/lib/messaging/providers/openphone');
    const provider = new OpenPhoneProvider('key', 'PN_1');
  ...
  it('OpenPhone provider parseStatusCallback handles unknown status', () => {
    const { OpenPhoneProvider } = require('@/lib/messaging/providers/openphone');
    const provider = new OpenPhoneProvider('key', 'PN_1');
