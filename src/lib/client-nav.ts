...
export const CLIENT_BOTTOM_TABS = [
  ...
  CLIENT_TABS[3], // Pets
  CLIENT_TABS[4], // Messages
  CLIENT_TABS[7], // Profile
] as const;
...
export const CLIENT_NAV_GROUPS = [
  ...
  {
    label: 'Operations',
    items: [CLIENT_TABS[1], CLIENT_TABS[2], CLIENT_TABS[3], CLIENT_TABS[4], CLIENT_TABS[5], CLIENT_TABS[6]],
  },
  { label: 'Account', items: [CLIENT_TABS[7]] },
] as const;
