...
export const EditBookingModal: React.FC<EditBookingModalProps> = ({
  ...
  const validateForm = (): boolean => {
    const validation = validateFormPayload({
      ...
      startAt: formData.startAt ? new Date(formData.startAt).toISOString() : booking.startAt.toISOString(),
      endAt: formData.endAt ? new Date(formData.endAt).toISOString() : booking.endAt.toISOString(),
