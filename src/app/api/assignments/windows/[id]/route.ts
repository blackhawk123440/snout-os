/**
 * Assignment Window Detail Route
 * 
 * DELETE /api/assignments/windows/[id]
 * Proxies to NestJS API for deleting assignment windows
 */
...
export async function DELETE(
  ...
  const apiUrl = `${API_BASE_URL}/api/assignments/windows/${windowId}`;
  ...
  try {
    ...
    console.error('[BFF Proxy] Failed to forward delete window request:', error);
    return NextResponse.json(
