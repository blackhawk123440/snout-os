          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <Link
                ...
                className="px-3 py-2 text-xs sm:text-sm font-bold border-2 rounded-lg hover:opacity-90 transition-all whitespace-nowrap touch-manipulation min-h-[44px] flex items-center justify-center"
              ...
              <Link
                href="/bookings"
                className="px-3 py-2 text-xs sm:text-sm font-medium border rounded-lg hover:bg-gray-50 transition-colors whitespace-nowrap touch-manipulation min-h-[44px] sm:min-h-auto"
