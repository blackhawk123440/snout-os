          ...
          <AppCard>
            <AppCardBody>
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-neutral-700">Monthly budget (cents)</label>
                  <p className="text-xs text-neutral-500">0 = unlimited</p>
                  <Input
                    type="number"
                    min={0}
                    value={budgetInput}
          ...
          <AppCard>
            <AppCardBody>
              ...
              <div className="mb-4 flex flex-wrap gap-2">
                <Input
                  placeholder="Key (e.g. daily_delight)"
                  value={templateKey}
