-- Complete migration SQL with all missing tables
-- Run this if the original migration is incomplete
...
-- ThreadParticipant
DO $$ BEGIN
 IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'ThreadParticipant_threadId_fkey') THEN
...
-- AssignmentWindow
DO $$ BEGIN
 IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'AssignmentWindow_orgId_fkey') THEN
  ALTER TABLE "AssignmentWindow" ADD CONSTRAINT "AssignmentWindow_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
 END IF;
END $$;

DO $$ BEGIN
 IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'AssignmentWindow_threadId_fkey') THEN
  ALTER TABLE "AssignmentWindow" ADD CONSTRAINT "AssignmentWindow_threadId_fkey" FOREIGN KEY ("threadId") REFERENCES "Thread"("id") ON DELETE CASCADE ON UPDATE CASCADE;
 END IF;
END $$;

DO $$ BEGIN
 IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'AssignmentWindow_sitterId_fkey') THEN
...
-- RoutingOverride
DO $$ BEGIN
 IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'RoutingOverride_orgId_fkey') THEN
  ALTER TABLE "RoutingOverride" ADD CONSTRAINT "RoutingOverride_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
 END IF;
END $$;

DO $$ BEGIN
 IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'RoutingOverride_threadId_fkey') THEN
  ALTER TABLE "RoutingOverride" ADD CONSTRAINT "RoutingOverride_threadId_fkey" FOREIGN KEY ("threadId") REFERENCES "Thread"("id") ON DELETE CASCADE ON UPDATE CASCADE;
 END IF;
END $$;

DO $$ BEGIN
 IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'RoutingOverride_targetId_fkey') THEN
  ALTER TABLE "RoutingOverride" ADD CONSTRAINT "RoutingOverride_targetId_fkey" FOREIGN KEY ("targetId") REFERENCES "Sitter"("id") ON DELETE SET NULL ON UPDATE CASCADE;
 END IF;
END $$;

-- PolicyViolation
DO $$ BEGIN
 IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'PolicyViolation_orgId_fkey') THEN
...
DO $$ BEGIN
 IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'PolicyViolation_threadId_fkey') THEN
  ALTER TABLE "PolicyViolation" ADD CONSTRAINT "PolicyViolation_threadId_fkey" FOREIGN KEY ("threadId") REFERENCES "Thread"("id") ON DELETE CASCADE ON UPDATE CASCADE;
 END IF;
END $$;

DO $$ BEGIN
 IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'PolicyViolation_messageId_fkey') THEN
  ALTER TABLE "PolicyViolation" ADD CONSTRAINT "PolicyViolation_messageId_fkey" FOREIGN KEY ("messageId") REFERENCES "Message"("id") ON DELETE SET NULL ON UPDATE CASCADE;
 END IF;
END $$;

-- Automation
DO $$ BEGIN
 IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'Automation_orgId_fkey') THEN
...
-- AutomationExecution
DO $$ BEGIN
 IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'AutomationExecution_orgId_fkey') THEN
...
-- AuditEvent
DO $$ BEGIN
 IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'AuditEvent_orgId_fkey') THEN
